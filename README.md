...
Para referencia interna y adendas generales:
...
INFORMACION_ADICIONAL = etree.SubElement(InformacionAdicional, ns+"INFORMACION_ADICIONAL")
Detalle = etree.SubElement(INFORMACION_ADICIONAL, ns+"Detalle", Data="OBSERVACIONES", Value=factura.narration.striptags() if factura.narration else "")
```
